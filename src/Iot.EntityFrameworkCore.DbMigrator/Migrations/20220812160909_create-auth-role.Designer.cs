...
namespace Iot.EntityFrameworkCore.Dbmigrator.Migrations
{
    ...
    [Migration("20220812160909_create-auth-role")]
    partial class createauthrole
    {
            ...
            modelBuilder.Entity("Iot.Devices.IotDevices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5692e070-7613-40c2-8c37-5bf28cf0d82d"),
                            ConcurrencyStamp = "b2806e929d734c6991ca3af548d8b0a8",
                            ...
                            Stats = 1,
                            Type = 0,
                            UserInfoId = new Guid("7df41acd-c9ff-4f63-8c68-43c4b4ed1d1d")
                        });
                });
            ...
            modelBuilder.Entity("Iot.Users.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7df41acd-c9ff-4f63-8c68-43c4b4ed1d1d"),
                            AccountNumber = "admin",
                            Avatar = "https://xiaohuchat.oss-cn-beijing.aliyuncs.com/ima/admin.jpg",
                            ConcurrencyStamp = "8f6db9de7bb249d8bac28a81bf0eed1f",
                            Introduce = "超级管理员",
                            IsDeleted = false,
                            Name = "管理员",
                            Password = "dd666666",
