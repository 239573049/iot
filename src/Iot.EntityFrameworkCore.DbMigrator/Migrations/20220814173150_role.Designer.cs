            ...
            modelBuilder.Entity("Iot.Devices.IotDevices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0ac57608-7cf8-40fe-90c0-56700ac2798e"),
                            ConcurrencyStamp = "349b6cfc58f2422494a84403034875da",
                            ...
                            Stats = 1,
                            Type = 0,
                            UserInfoId = new Guid("f2128057-61c5-4b0a-9a26-b0af8f31cb26")
                        });
                });
            ...
            modelBuilder.Entity("Iot.Users.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f2128057-61c5-4b0a-9a26-b0af8f31cb26"),
                            AccountNumber = "admin",
                            Avatar = "https://xiaohuchat.oss-cn-beijing.aliyuncs.com/ima/admin.jpg",
                            ConcurrencyStamp = "4f55fa02ea3944e8afcc26c0454c535e",
                            CreationTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Introduce = "超级管理员",
                            IsDeleted = false,
                            Name = "管理员",
